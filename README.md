...
1. Installation and environment configuration ([rm_install](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_install))
...
3. Hardware driver ([rm_driver](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_driver))
...
5. Launch ([rm_bringup](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_bringup))
...
6. Model description ([rm_description](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_description))
...
7. ROS message interface ([rm_ros_interfaces](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_ros_interfaces))
...
8. MoveIt2 control programs ([rm_moveit2](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_moveit2))
...
9. Moveit2 configuration ([rm_moveit2_config](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_moveit2_config))
...
11. Gazebo simulation robotic arm control ([rm_gazebo](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_gazebo))
