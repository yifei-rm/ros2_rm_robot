...
: rclcpp::Node("Move_demo_pub_node")
{
  ...
  movej_publisher_ = this->create_publisher<rm_ros_interfaces::msg::Movej>(
    "rm_driver/movej_cmd",
    rclcpp::ParametersQoS());
  movec_publisher_ = this->create_publisher<rm_ros_interfaces::msg::Movec>(
    "rm_driver/movec_cmd",
    rclcpp::ParametersQoS());
