...
1. 安装与环境配置([rm_install](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_install))

* 该功能包为机械臂使用辅助功能包，主要作用为介绍功能包使用环境安装与搭建方式，功能包的依赖库安装和功能包编译方法。

3. 硬件驱动([rm_driver](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_driver))

* 该功能包为机械臂的ROS2底层驱动功能包，其作用为订阅和发布机械臂底层相关话题信息。

5. 启动([rm_bringup](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_bringup))

* 该功能包为机械臂的节点启动功能包，其作用为快速启动多节点复合的机械臂功能。

6. 模型描述([rm_description](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_description))

* 该功能包为机械臂模型描述功能包，其作用为提供机械臂模型文件和模型加载节点，并为其他功能包提供机械臂关节间的坐标变换关系。

7. ROS消息接口([rm_ros_interfaces](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_ros_interfaces))

* 该功能包为机械臂的消息文件功能包，其作用为提供机械臂适配ROS2的所有控制消息和状态消息。

8. MoveIt2控制程序([rm_moveit2](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_moveit2))

* 该功能包提供基于MoveIt2的控制示例程序，支持真实机械臂与仿真机械臂的关节运动、位姿目标控制和笛卡尔轨迹控制。

9. Moveit2配置([rm_moveit2_config](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_moveit2_config))
...
11. Gazebo仿真机械臂控制([rm_gazebo](https://github.com/RealManRobot/ros2_rm_robot/tree/foxy/rm_gazebo))
...
<arm_type>需要使用65、75、eco62、eco63、eco65、63、63_III、gen72、gen72_II字符进行代替。RX75 请直接使用 `rm_rx75_6fb_gazebo.launch.py` 或 `rm_rx75_6fb_v_gazebo.launch.py`。如使用RM65机械臂时，命令如下。
...
<arm_type>需要使用65、75、eco62、eco63、eco65、63、63_III、gen72、gen72_II字符进行代替。RX75 请直接使用 `rm_rx75_6fb_bringup.launch.py` 或 `rm_rx75_6fb_v_bringup.launch.py`。如使用RM65机械臂时，命令如下。
