...
def generate_launch_description():
    ...
    # planning_context
    xacro_args = {"link6_type": "Link6_6fb","base_type": "base_link_III"}
    ...
    robot_description_semantic_config = load_file(
        "rm_63_config", "config/rml_63_description.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "rm_63_config", "config/kinematics.yaml"
    )
    ...
    # RViz
    rviz_base = os.path.join(get_package_share_directory("rm_63_config"), "rviz")
