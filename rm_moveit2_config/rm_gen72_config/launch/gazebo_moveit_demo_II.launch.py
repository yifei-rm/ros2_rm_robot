...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file(
        "rm_gen72_config", "config/rm_gen72_description.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "rm_gen72_config", "config/kinematics.yaml"
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        "rm_gen72_config", "config/moveit_controllers.yaml"
    )
    ...
    rviz_base = os.path.join(get_package_share_directory("rm_gen72_config"), "rviz")
