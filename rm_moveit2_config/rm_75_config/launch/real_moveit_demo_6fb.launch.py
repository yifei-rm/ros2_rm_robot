...
def generate_launch_description():
    ...
    # planning_context
    xacro_args = {"link7_type": "Link7_6fb"}
    ...
    kinematics_yaml = load_yaml(
        "rm_75_config", "config/kinematics.yaml"
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        "rm_75_config", "config/moveit_controllers.yaml"
    )
    ...
    rviz_base = os.path.join(get_package_share_directory("rm_75_config"), "rviz")
