...
|   功能描述   | 配置控制器通讯端口RS485模式                                                                                                                                                      |
| :----------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   参数说明   | RS485params.msg <br>int32 mode: 0-控制器RS485端口为RTU主站，1-末端接口板RS485接口为RTU主站，2-控制器RS485端口为RTU从站。<br>int32 baudrate: 当前支持9600,115200,460800。<br>int32 timeout: Modbus RTU超时时间，单位100ms。 |
...
| :----------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   参数说明   | Modbustcpmasterinfo.msg <br>string master_name: Modbus主站名称(三代控制器无需配置)。<br>string ip: TCP主站IP地址。<br>int32 port: TCP主站端口号。<br>int32 timeout: Modbus TCP超时时间，单位ms。 |
