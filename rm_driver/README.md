...
# RealMan Robot rm_driver User Manual V1.8
...
|V1.8   | 2026-8-13 | Amend(Add the unified driver entry, SDK library V1.1.6, endpoint ownership, safe shutdown/reconnect handling, header/source cleanup, and array initialization/bounds warning fixes) |
...
│   └── rm_driver
│       ├── rm_define.h            # API definition header file
│       ├── rm_driver.h            # rm_driver.cpp header file
│       ├── rm_interface.h         # driver interface header file
│       ├── rm_interface_global.h  # interface export header file
│       ├── rm_service.h           # service interface header file
│       └── rm_version.h           # version definition header file
├── launch
...
├── lib
│   ├── lib_install.sh                                   # API library installation script
│   ├── libapi_cpp.so                                    # default API library
│   ├── linux_arm64_c++_v1.1.6
│   │   └── libapi_cpp.so                                # ARM64 API library
│   └── linux_x86_c++_v1.1.6
│       └── libapi_cpp.so                                # x86_64 API library
