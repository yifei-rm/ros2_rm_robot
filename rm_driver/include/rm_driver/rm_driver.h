...
#ifndef RM_DRIVER__RM_DRIVER_H_
#define RM_DRIVER__RM_DRIVER_H_
...
/**********************************************初始化需要用到的回调函数***********************************************/
  ...
  void Set_UDP_Configuration(
    int udp_cycle, int udp_port, int udp_force_coordinate,
    std::string udp_ip, bool hand, bool rm_plus_base, bool rm_plus_state);  // 设置udp主动上报配置
  /*******************************运动控制回调函数******************************/
  ...
  void Arm_Force_Position_Move_Callback(
    const rm_ros_interfaces::msg::Forcepositionmove::SharedPtr msg);  // 力位混合透传（补偿）
  void Arm_Set_Force_Postion_Callback(
    const rm_ros_interfaces::msg::Setforceposition::SharedPtr msg);  // 使能力位混合透传
  ...
  void Get_Trajectory_File_List_Callback(
  ...
  void Add_Modbus_Tcp_Master_Callback(
    const rm_ros_interfaces::msg::Modbustcpmasterinfo::SharedPtr msg);  // 新增Modbus TCP主站
  void Update_Modbus_Tcp_Master_Callback(
    const rm_ros_interfaces::msg::Modbustcpmasterupdata::SharedPtr msg);  // 更新Modbus TCP主站
  ...
  void Get_Modbus_Tcp_Master_List_Callback(
    const rm_ros_interfaces::msg::Getmodbustcpmasterlist::SharedPtr msg);  // 查询modbus主站列表
  ...
  void Read_Modbus_RTU_Coils_Callback(
    const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr msg);  //  Modbus RTU协议读线圈
  void Write_Modbus_RTU_Coils_Callback(
    const rm_ros_interfaces::msg::Modbusrtuwriteparams::SharedPtr msg);  //  Modbus RTU协议写线圈
  void Read_Modbus_RTU_Input_Status_Callback(
    const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr msg);  //  Modbus RTU协议读离散量输入
  void Read_Modbus_RTU_Holding_Registers_Callback(
    const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr msg);  //  Modbus RTU协议读保持寄存器
  void Write_Modbus_RTU_Registers_Callback(
    const rm_ros_interfaces::msg::Modbusrtuwriteparams::SharedPtr msg);  //  Modbus RTU协议写保持寄存器
  void Read_Modbus_RTU_Input_Registers_Callback(
    const rm_ros_interfaces::msg::Modbusrtureadparams::SharedPtr msg);  //  Modbus RTU协议读输入寄存器
  void Read_Modbus_TCP_Coils_Callback(
    const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr msg);  //  Modbus TCP协议读线圈
  void Write_Modbus_TCP_Coils_Callback(
    const rm_ros_interfaces::msg::Modbustcpwriteparams::SharedPtr msg);  //  Modbus TCP协议写线圈
  void Read_Modbus_TCP_Input_Status_Callback(
    const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr msg);  //  Modbus TCP协议读离散量输入
  void Read_Modbus_TCP_Holding_Registers_Callback(
    const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr msg);  //  Modbus TCP协议读保持寄存器
  void Write_Modbus_TCP_Registers_Callback(
  ...
  void Read_Modbus_TCP_Input_Registers_Callback(
    const rm_ros_interfaces::msg::Modbustcpreadparams::SharedPtr msg);  //  Modbus TCP协议读输入寄存器

  void Close_Controller_Tcp_Modbus_Callback(const std_msgs::msg::Empty::SharedPtr msg);  // 关闭tcp modbus
  void Set_Controller_Tcp_Mode_Callback(
    const rm_ros_interfaces::msg::Modbustcpmasterinfo::SharedPtr msg);  // 设置tcp modbus
...
/************************************************************变量信息******************************************************/
  ...
  /****************************************udp主动上报配置查询发布器*************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Setrealtimepush >
  ::SharedPtr Get_Realtime_Push_Result;
  /****************************************udp主动上报配置查询订阅器*************************************/
  ...
  /******************************************udp主动上报配置发布器***************************************/
  rclcpp::Subscription < rm_ros_interfaces::msg::Setrealtimepush >
  ::SharedPtr Set_Realtime_Push_Cmd;
  /**********************************************************end******************************************************/
  ...
  rclcpp::Subscription < rm_ros_interfaces::msg::Jointposcustom >
  ::SharedPtr Movej_CANFD_Custom_Cmd;
  /*******************************************角度透传运动控制订阅器*************************************/
  ...
  rclcpp::Subscription < rm_ros_interfaces::msg::Carteposcustom >
  ::SharedPtr Movep_CANFD_Custom_Cmd;
  /****************************************MoveJ_P运动控制结果发布器*************************************/
  ...
  rclcpp::Publisher < rm_ros_interfaces::msg::Armsoftversion >
  ::SharedPtr Get_Arm_Software_Version_Result;
  ...
  rclcpp::Publisher < rm_ros_interfaces::msg::Jointversion >
  ::SharedPtr Get_Joint_Software_Version_Result;
  rclcpp::Subscription < std_msgs::msg::Empty > ::SharedPtr Get_Joint_Software_Version_Cmd;
  rclcpp::Publisher < rm_ros_interfaces::msg::Toolsoftwareversionv4 >
  ::SharedPtr Get_Tool_Software_Version_Result;
  rclcpp::Subscription < std_msgs::msg::Empty > ::SharedPtr Get_Tool_Software_Version_Cmd;
  rclcpp::Publisher < rm_ros_interfaces::msg::Flowchartrunstate >
  ::SharedPtr Get_Flowchart_Program_Run_State_Result;
  rclcpp::Subscription < std_msgs::msg::Empty > ::SharedPtr Get_Flowchart_Program_Run_State_Cmd;
  /*************************************************轨迹列表相关接口****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Trajectorylist >
  ::SharedPtr Get_Trajectory_File_List_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Gettrajectorylist >
  ::SharedPtr Get_Trajectory_File_List_Cmd;
  ...
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpmasterinfo >
  ::SharedPtr Add_Modbus_Tcp_Master_Cmd;
  /*************************************************更新Modbus TCP主站****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Update_Modbus_Tcp_Master_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpmasterupdata >
  ::SharedPtr Update_Modbus_Tcp_Master_Cmd;
  /*************************************************删除Modbus TCP主站****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Delete_Modbus_Tcp_Master_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Mastername >
  ::SharedPtr Delete_Modbus_Tcp_Master_Cmd;
  /*************************************************查询指定modbus主站****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbustcpmasterinfo >
  ::SharedPtr Get_Modbus_Tcp_Master_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Mastername > ::SharedPtr Get_Modbus_Tcp_Master_Cmd;
  /*************************************************查询modbus主站列表****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbustcpmasterlist >
  ::SharedPtr Get_Modbus_Tcp_Master_List_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Getmodbustcpmasterlist >
  ::SharedPtr Get_Modbus_Tcp_Master_List_Cmd;
  /*************************************************设置控制器RS485模式(四代三代控制器支持)****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Set_Controller_RS485_Mode_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::RS485params >
  ::SharedPtr Set_Controller_RS485_Mode_Cmd;
  /*************************************************查询控制器RS485模式(四代控制器支持)****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::RS485params >
  ::SharedPtr Get_Controller_RS485_Mode_v4_Result;
  ...
  rclcpp::Publisher < rm_ros_interfaces::msg::RS485params >
  ::SharedPtr Get_Tool_RS485_Mode_v4_Result;
  ...
  // rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr Close_Controller_Tcp_Modbus_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpmasterinfo >
  ::SharedPtr Set_Controller_Tcp_Modbus_Cmd;
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Set_Controller_Tcp_Modbus_Result;


  /*************************************************Modbus RTU协议读线圈****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_RTU_Coils_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbusrtureadparams >
  ::SharedPtr Read_Modbus_RTU_Coils_Cmd;
  /*************************************************Modbus RTU协议写线圈****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Write_Modbus_RTU_Coils_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbusrtuwriteparams >
  ::SharedPtr Write_Modbus_RTU_Coils_Cmd;
  /*************************************************Modbus RTU协议读离散量输入****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_RTU_Input_Status_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbusrtureadparams >
  ::SharedPtr Read_Modbus_RTU_Input_Status_Cmd;
  /*************************************************Modbus RTU协议读保持寄存器****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_RTU_Holding_Registers_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbusrtureadparams >
  ::SharedPtr Read_Modbus_RTU_Holding_Registers_Cmd;
  /*************************************************Modbus RTU协议写保持寄存器****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Write_Modbus_RTU_Registers_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbusrtuwriteparams >
  ::SharedPtr Write_Modbus_RTU_Registers_Cmd;
  /*************************************************Modbus RTU协议读输入寄存器****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_RTU_Input_Registers_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbusrtureadparams >
  ::SharedPtr Read_Modbus_RTU_Input_Registers_Cmd;

  /*************************************************Modbus TCP协议读线圈****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_TCP_Coils_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpreadparams >
  ::SharedPtr Read_Modbus_TCP_Coils_Cmd;
  /*************************************************Modbus TCP协议写线圈****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Write_Modbus_TCP_Coils_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpwriteparams >
  ::SharedPtr Write_Modbus_TCP_Coils_Cmd;
  /*************************************************Modbus TCP协议读离散量输入****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_TCP_Input_Status_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpreadparams >
  ::SharedPtr Read_Modbus_TCP_Input_Status_Cmd;
  /*************************************************Modbus TCP协议读保持寄存器****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_TCP_Holding_Registers_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpreadparams >
  ::SharedPtr Read_Modbus_TCP_Holding_Registers_Cmd;
  /*************************************************Modbus TCP协议写保持寄存器****************************************/
  rclcpp::Publisher < std_msgs::msg::Bool > ::SharedPtr Write_Modbus_TCP_Registers_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpwriteparams >
  ::SharedPtr Write_Modbus_TCP_Registers_Cmd;
  /*************************************************Modbus TCP协议读输入寄存器****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Modbusreaddata >
  ::SharedPtr Read_Modbus_TCP_Input_Registers_Result;
  rclcpp::Subscription < rm_ros_interfaces::msg::Modbustcpreadparams >
  ::SharedPtr Read_Modbus_TCP_Input_Registers_Cmd;
  ...
  /*************************************************查询在线编程运行状态****************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Programrunstate >
  ::SharedPtr Get_Program_Run_State_Result;
  ...
  /************************************************设置力位混合控制************************************************/
  rclcpp::Subscription < rm_ros_interfaces::msg::Setforceposition >
  ::SharedPtr Set_Force_Postion_Cmd;
  /********************************************结束力位混合控制结果发布器*******************************************/
  ...
  /**************************************************力位混合角度透传订阅器***************************************/
  rclcpp::Subscription < rm_ros_interfaces::msg::Forcepositionmovejoint >
  ::SharedPtr Force_Position_Move_Joint_Cmd;
  /***********************************************力位混合位姿透传订阅器*********************************************/
  rclcpp::Subscription < rm_ros_interfaces::msg::Forcepositionmovepose >
  ::SharedPtr Force_Position_Move_Pose_Cmd;
  /***********************************************力位混合补偿透传订阅器*********************************************/
  rclcpp::Subscription < rm_ros_interfaces::msg::Forcepositionmove >
  ::SharedPtr Force_Position_Move_Cmd;
  /**********************************************************************end************************************************************/
  ...
  /******************************************清除关节错误代码订阅器**********************************/
  rclcpp::Subscription < rm_ros_interfaces::msg::Jointerrclear >
  ::SharedPtr Set_Joint_Err_Clear_Cmd;
...
/********************************************************************end***********************************************************/
  ...
  /**************************************获取机械臂当前状态发布器*************************************/
  rclcpp::Publisher < rm_ros_interfaces::msg::Armoriginalstate >
  ::SharedPtr Get_Current_Arm_Original_State_Result;
  /**************************************获取机械臂当前状态发布器*************************************/
...
private:
  ...
  rclcpp::Publisher < rm_ros_interfaces::msg::Armcurrentstatus >
  ::SharedPtr Arm_Current_Status_Result;  // 机械臂当前状态发布器
  ...
  rclcpp::Publisher < rm_ros_interfaces::msg::Jointtemperature >
  ::SharedPtr Joint_Temperature_Result;  // 关节温度发布器
